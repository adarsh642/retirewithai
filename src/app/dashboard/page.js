...
export default function DashboardPage() {
  ...
  <div className="dashboard-scope relative flex min-h-screen w-full bg-background text-on-surface" style={{ backgroundColor: 'var(--background, #120B1C)' }}>
        ...
        <div className="flex flex-1 flex-col">
          <header className="flex h-16 shrink-0 items-center justify-end border-b border-surface bg-background/80 px-6 backdrop-blur-md" style={{ backgroundColor: 'rgb(18 11 28 / 0.8)' }}>
            <button className="relative rounded-full p-2 transition-colors hover:bg-surface">
          ...
          <main className="flex-1 overflow-y-auto px-4 py-8 sm:px-6 lg:px-8">
            ...
            <div className="grid grid-cols-12 gap-6 lg:gap-8">
              <div className="col-span-12 lg:col-span-8">
                <h2 className="mb-6 text-3xl font-bold tracking-tight text-white">Your Retirement Dashboard</h2>
                <div className="mb-8 grid grid-cols-1 gap-4 sm:grid-cols-2 xl:grid-cols-4">
                  <div className="flex flex-col justify-between rounded-2xl bg-surface p-4 glowing-border ring-1 ring-white/10 shadow-[0_8px_24px_rgba(0,0,0,0.35)] transition-all duration-300 hover:bg-[#2a1a40] hover:glowing-shadow" style={{ backgroundColor: 'var(--surface, #1E122D)' }}>
                    <p className="text-sm font-medium text-on-surface-variant">Current Corpus</p>
                  ...
                  <div className="flex flex-col justify-between rounded-2xl bg-surface p-4 glowing-border ring-1 ring-white/10 shadow-[0_8px_24px_rgba(0,0,0,0.35)] transition-all duration-300 hover:bg-[#2a1a40] hover:glowing-shadow" style={{ backgroundColor: 'var(--surface, #1E122D)' }}>
                    <p className="text-sm font-medium text-on-surface-variant">Required Corpus</p>
                  ...
                  <div className="flex flex-col items-center justify-center gap-2 rounded-2xl bg-surface p-4 glowing-border ring-1 ring-white/10 shadow-[0_8px_24px_rgba(0,0,0,0.35)] transition-all duration-300 hover:bg-[#2a1a40] hover:glowing-shadow" style={{ backgroundColor: 'var(--surface, #1E122D)' }}>
                    <p className="text-sm font-medium text-on-surface-variant -mt-1">Success Probability</p>
                    <div className="relative h-24 w-24">
                      ...
                      <p className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 text-2xl font-bold text-secondary">85%</p>
                    </div>
                  </div>
                  <div className="flex flex-col justify-between rounded-2xl bg-surface p-4 glowing-border ring-1 ring-white/10 shadow-[0_8px_24px_rgba(0,0,0,0.35)] transition-all duration-300 hover:bg-[#2a1a40] hover:glowing-shadow" style={{ backgroundColor: 'var(--surface, #1E122D)' }}>
                    <p className="text-sm font-medium text-on-surface-variant">Monthly SIP</p>
                ...
                <div className="group relative mb-8 rounded-2xl bg-surface p-6 glowing-border ring-1 ring-white/10 shadow-[0_10px_30px_rgba(0,0,0,0.35)]" style={{ backgroundColor: 'var(--surface, #1E122D)' }}>
                  ...
                  <div className="mb-4 flex flex-wrap items-start justify-between gap-4">
                    <div>
                      <p className="text-lg font-semibold text-white">Retirement Projection</p>
                      <p className="text-sm text-on-surface-variant">Projected corpus at retirement age 60</p>
                    </div>
                    <div className="text-right">
                      <p className="text-3xl font-bold neon-gradient-text">$1,215,000</p>
                      <p className="text-sm font-medium text-green-400">+12% vs last month</p>
                    </div>
                  </div>
                  ...
                  <div className="relative pt-4">
                    <label className="mb-2 block text-sm font-medium text-white" htmlFor="retirementAge">Retirement Age: <span className="font-bold text-secondary">60</span></label>
                ...
                <div className="grid grid-cols-1 gap-6 md:grid-cols-3">
                  <div className="group flex cursor-pointer flex-col items-start gap-4 rounded-2xl bg-surface p-6 glowing-border ring-1 ring-white/10 shadow-[0_8px_24px_rgba(0,0,0,0.35)] transition-all duration-300 hover:bg-[#2a1a40] hover:glowing-shadow" style={{ backgroundColor: 'var(--surface, #1E122D)' }}>
                    ...
                    <h3 className="font-semibold text-white">Tax Optimizer</h3>
                    <p className="flex-grow text-sm text-on-surface-variant">Optimize your investments for maximum tax efficiency.</p>
                    <a className="flex items-center gap-1 text-sm font-semibold text-secondary opacity-0 transition-opacity duration-300 group-hover:opacity-100 hover:underline" href="#">Optimize Now <span className="material-symbols-outlined text-sm">arrow_forward</span></a>
                  </div>
                  <div className="group flex cursor-pointer flex-col items-start gap-4 rounded-2xl bg-surface p-6 glowing-border ring-1 ring-white/10 shadow-[0_8px_24px_rgba(0,0,0,0.35)] transition-all duration-300 hover:bg-[#2a1a40] hover:glowing-shadow" style={{ backgroundColor: 'var(--surface, #1E122D)' }}>
                    <div className="rounded-xl bg-gradient-to-br from-primary to-secondary p-3">
                      <span className="material-symbols-outlined text-white">pie_chart</span>
                    </div>
                    <h3 className="font-semibold text-white">Personalized Plan</h3>
              ...
              <aside className="col-span-12 space-y-8 lg:col-span-4">
                <div className="sticky top-8 rounded-2xl bg-surface p-6 glowing-border ring-1 ring-white/10 shadow-[0_10px_30px_rgba(0,0,0,0.35)]" style={{ backgroundColor: 'var(--surface, #1E122D)' }}>
                  <h3 className="mb-6 flex items-center gap-2 text-xl font-bold text-white"><span className="material-symbols-outlined text-3xl text-secondary">psychology</span>Personalized Insights</h3>
                  <div className="space-y-6">
                    ...
                    <div className="flex items-start gap-4 rounded-lg border border-surface bg-background/50 p-4 transition-colors hover:border-green-400/50">
                      <span className="material-symbols-outlined mt-1 text-green-400">recommend</span>
                      <div>
                        <h4 className="font-semibold text-white">Increase SIP by 10%</h4>
                        <p className="text-sm text-on-surface">A small increase in your SIP can lead to a <span className="font-bold text-white">$150,000</span> corpus increase.</p>
                        <button className="mt-2 text-sm font-semibold text-secondary hover:underline">Increase Now</button>
                      </div>
                    </div>
                    <div className="flex items-start gap-4 rounded-lg border border-surface bg-background/50 p-4 transition-colors hover:border-blue-400/50">
                      <span className="material-symbols-outlined mt-1 text-blue-400">lightbulb</span>
                      <div>
                        <h4 className="font-semibold text-white">Diversification Opportunity</h4>
                        <p className="text-sm text-on-surface">Consider diversifying into international equities to improve long-term returns.</p>
                        <button className="mt-2 text-sm font-semibold text-secondary hover:underline">Explore Funds</button>
                      </div>
                    </div>
                    <div className="mt-8 border-t border-surface pt-6">
                      <h4 className="mb-4 text-lg font-bold text-white">Quick Actions</h4>
                      <div className="space-y-3">
                        <button className="flex h-12 w-full items-center justify-between rounded-lg border border-surface bg-background px-4 font-semibold text-white transition-all duration-300 hover:border-primary hover:bg-[#2a1a40]">
          ...
          <footer className="px-4 py-6 text-center">
            <p className="text-sm text-on-surface-variant">Made for salaried India • Data stays private & secure</p>
          </footer>
        </div>
      </div>
    </>
